...
public partial class DeviceEditorViewModel : ObservableObject
{
    ...
    private readonly RemoteManager.Core.Discovery.ILanProbe? networks;
    ...
    public DeviceEditorViewModel(IDeviceRepository repository, ILogger logger, Device? device = null, bool isNew = false, RemoteManager.Core.Discovery.ILanProbe? networks = null)
    {
        this.isNew = isNew;
