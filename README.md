...
Verification: Release build clean, 96 tests passing, offscreen WPF smoke checks passing. See [verification details](docs/VERIFICATION.md). Run the UI harness with `dotnet run --project tools/MythLab.SmokeTests -c Release`.
