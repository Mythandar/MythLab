...
internal sealed class SmokeStatus : MythLab.Core.Monitoring.IDeviceStatusService
{
    public Queue<DeviceState> Sequence { get; set; } = [];
    public DeviceState DefaultState { get; set; } = DeviceState.Online;
    private int active;
    public int MaximumActive { get; private set; }
    public async Task<MythLab.Core.Monitoring.StatusObservation> CheckAsync(Device device, int timeoutMilliseconds, CancellationToken cancellationToken = default)
    {
        active++;
...
internal sealed class SmokeWake : MythLab.Core.WakeOnLan.IWakeOnLanService
{
    public int Calls { get; private set; }
    public Task<MythLab.Core.WakeOnLan.WakeSendReport> SendAsync(Device device, IProgress<MythLab.Core.WakeOnLan.WakeProgress> progress, CancellationToken cancellationToken = default)
    {
        Calls++;
